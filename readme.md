...
- Put a script tag similar to this `<script src='https://unpkg.com/claps-button@1.1.5/dist/mycomponent.js'></script>` in the head of your index.html
- Then you can use the element anywhere in your template, JSX, html etc

```html
<!--in your index.html-->
<script src='https://unpkg.com/claps-button@1.1.5/dist/claps-button.js'></script>
<!-- // other code -->
```
